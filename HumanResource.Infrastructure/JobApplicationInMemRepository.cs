...
{
    public class JobApplicationInMemRepository : IJobApplicationRepository
    {
        private IList<JobApplication> store;

        public JobApplicationInMemRepository()
        {
            this.store = new List<JobApplication>();
        }
